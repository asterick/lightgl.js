...
var HitTest = require("./hitTest.js");
...
var GL = {
  ...
  create: function(options) {
    ...
    try {
      window.gl = canvas.getContext("webgl", options) || canvas.getContext("experimental-webgl", options);
    }
    catch(e) {}
...
function addOtherMethods() {
  ...
  (function(context) {
    window.gl.makeCurrent = function() {
      window.gl = context;
    };
  })(gl);
